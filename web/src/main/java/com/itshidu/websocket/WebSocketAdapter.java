...
import com.itshidu.websocket.framing.FramedataImpl1;
import com.itshidu.websocket.framing.Framedata.Opcode;
import com.itshidu.websocket.handshake.ClientHandshake;
import com.itshidu.websocket.handshake.HandshakeImpl1Server;
...
public abstract class WebSocketAdapter implements WebSocketListener {
	 ...
	 *
	 * @see com.itshidu.websocket.WebSocketListener#onWebsocketHandshakeReceivedAsServer(WebSocket, Draft, ClientHandshake)
	 */
	 ...
	 *
	 * @see com.itshidu.websocket.WebSocketListener#onWebsocketHandshakeSentAsClient(WebSocket, ClientHandshake)
	 */
	 ...
	 * This default implementation does not do anything. Go ahead and overwrite it
	 *
	 * @see com.itshidu.websocket.WebSocketListener#onWebsocketMessageFragment(WebSocket, Framedata)
	 */
	 ...
	 *
	 * @see com.itshidu.websocket.WebSocketListener#onWebsocketPing(WebSocket, Framedata)
	 */
	 ...
	 * This default implementation does not do anything. Go ahead and overwrite it.
	 *
	 * @see com.itshidu.websocket.WebSocketListener#onWebsocketPong(WebSocket, Framedata)
	 */
