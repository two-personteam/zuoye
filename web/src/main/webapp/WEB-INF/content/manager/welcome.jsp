...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="${res}/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v41">v4.2.0</a><code class="pull-right">2016.11.05</code>
                                            </h5>
                                    </div>
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <p id="pay-qrcode">
                            <a href="javascript:;"><img src="${res }/img/pay.png" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                            </a>
                        </p>
    ...
    <!-- 自定义js -->
    <script src="${res}/hplus4.2/js/content.js"></script>

    <!-- 欢迎信息 -->
    <script src="${res}/hplus4.2/js/welcome.js"></script>
</body>
