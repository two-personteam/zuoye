...
<head>
  ...
  <title>E动国际·学生信息管理系统</title>
  <link rel="stylesheet" href="${path}/assets/kit_admin/plugins/layui/css/layui.css" media="all" />
  <link rel="stylesheet" href="${path}/assets/kit_admin/plugins/font-awesome/css/font-awesome.min.css" media="all" />
  <link rel="stylesheet" href="${path}/assets/kit_admin/src/css/app.css" media="all" />
  <link rel="stylesheet" href="${path}/assets/kit_admin/src/css/themes/default.css" media="all" id="skin" kit-skin />
</head>
...
<body class="kit-theme">
  ...
  <script src="${path}/assets/kit_admin/plugins/layui/layui.js"></script>
  <script>
    var message;
    layui.config({
      base: '${path}/assets/kit_admin/src/js/',
      version: '1.0.1'
