...
<link href="${path }/assets/sweetalert/sweetalert.css" rel="stylesheet">
<script src="${path }/assets/sweetalert/sweetalert.min.js"></script>
</head>
<body>
...
<script type="text/javascript">
	$(function(){
		...
		var url={
				save:		'${path}/manage/student/save',
				update:		'${path}/manage/student/update',
				list:		'${path}/manage/student/list',
				remove:		'${path}/manage/student/remove'
		}
